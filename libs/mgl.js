...
var A, Actor, ActorGroup, C, Color, Config, Display, Drawing, DrawingRect, Fiber, G, Game, Key, Letter, M, Mouse, PI, Particle, ParticleActor, Random, RealtimeLeaderboard, Sound, Text, TextActor, Vector, abs, atan2, ceil, cos, floor, max, min, requestAnimFrame, requestAnimFrameSystem, sin, sqrt,
  __slice = [].slice,
...
Actor = (function() {
  ...
  Actor.getter('t', function() {
    return this.ticks;
  });

  Actor.setter('t', function(v) {
    return this.ticks = v;
  });
