...
var A, Actor, ActorCore, ActorGroup, ActorShorthand, C, Color, Config, DisableLineNoise, Display, Drawing, DrawingCore, DrawingRect, DrawingShorthand, EnableLineNoise, Fiber, FiberCore, FiberShorthand, G, Game, Key, Letter, M, Mouse, PI, Particle, ParticleActor, Random, RealtimeLeaderboard, Sound, Text, TextActor, Vector, abs, atan2, ceil, cos, floor, max, min, requestAnimFrame, requestAnimFrameSystem, sin, sqrt,
  __slice = [].slice,
