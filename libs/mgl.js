...
var A, Actor, ActorCore, ActorGroup, ActorShorthand, C, Color, Config, DisableLineNoise, Display, Drawing, DrawingCore, DrawingRect, DrawingShorthand, EnableLineNoise, Fiber, FiberCore, FiberShorthand, G, Game, Key, Letter, M, Mouse, PI, Particle, ParticleActor, Random, RealtimeLeaderboard, Sound, Text, TextActor, Vector, VectorCore, VectorShorthand, abs, atan2, ceil, cos, floor, max, min, requestAnimFrame, requestAnimFrameSystem, sin, sqrt,
  __slice = [].slice,
...
Game = (function() {
  ...
  Game.df = function(speed, scale) {
    ...
    return sqrt(this.ticks * speed * 0.0001) * scale + 1;
  };
  ...
  Game.classGetter('t', function() {
    return this.ticks;
  });

  Game.classGetter('sc', function() {
    return this.score;
  });

  Game.classSetter('sc', function(v) {
    return this.score = v;
  });
  ...
  Game.classGetter('ib', function() {
    return this.running;
  });

  Game.classGetter('r', function() {
    return this.random;
  });
  ...
  Game.updateFrame = function(time) {
    ...
    Display.drawText("" + Game.score, 1, 0, 1);
    Game.postUpdate();
    Game.ticks++;
    if (!Game.running) {
      Game.updateTitle();
...
Actor = (function() {
  ...
  Actor.clear = function(targetClasses) {
  ...
  Actor.prototype.removeGroups = function() {
    return Actor.groups = [];
  };
  ...
  Actor.prototype.onCollision = function(targetClass, handler) {
  ...
  Actor.sortGroups = function() {
    return Actor.groups.sort(function(v1, v2) {
      return v1.displayPriority - v2.displayPriority;
    });
  };

  function Actor() {
    var args, className, group, _i, _len, _ref;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    this.pos = new Vector;
    this.vel = new Vector;
    this.way = 0;
...
ActorShorthand = (function(_super) {
  __extends(ActorShorthand, _super);

  ActorShorthand.sc = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.scroll.apply(this, args);
  };

  ActorShorthand.getter('t', function() {
    return this.ticks;
  });

  ActorShorthand.setter('t', function(v) {
    return this.ticks = v;
  });

  ActorShorthand.getter('ir', function() {
    return this.isRemoving;
  });

  ActorShorthand.cl = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.clear.apply(this, args);
  };

  ActorShorthand.getter('r', function() {
    return this.remove();
  });

  ActorShorthand.prototype.dp = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.setDisplayPriority.apply(this, args);
  };

  ActorShorthand.prototype.oc = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.onCollision.apply(this, args);
  };

  ActorShorthand.getter({
    'nd': function() {
      return this.newDrawing;
    }
  });

  ActorShorthand.getter('nf', function() {
    return this.newFiber;
  });

  ActorShorthand.getter('np', function() {
    return this.newParticle;
  });

  ActorShorthand.getter('nr', function() {
  ...
  ActorShorthand.prototype.nt = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.newText.apply(this, args);
  };

  ActorShorthand.getter('p', function() {
    return this.pos;
  });

  ActorShorthand.setter('p', function(v) {
    return this.pos = v;
  });

  ActorShorthand.getter('v', function() {
    return this.vel;
  });

  ActorShorthand.setter('v', function(v) {
    return this.vel = v;
  });

  ActorShorthand.getter('s', function() {
    return this.speed;
  });

  ActorShorthand.setter('s', function(v) {
    return this.speed = v;
  });

  ActorShorthand.getter('w', function() {
    return this.way;
  });

  ActorShorthand.setter('w', function(v) {
    return this.way = v;
  });

  ActorShorthand.getter('d', function() {
    return this.drawing;
  });

  ActorShorthand.setter('d', function(v) {
    return this.drawing = v;
  });
  ...
  function ActorShorthand() {
    ...
    ActorShorthand.__super__.constructor.apply(this, args);
  }

  return ActorShorthand;
...
DrawingShorthand = (function(_super) {
  __extends(DrawingShorthand, _super);

  function DrawingShorthand() {
    return DrawingShorthand.__super__.constructor.apply(this, arguments);
  }

  DrawingShorthand.prototype.c = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.setColor.apply(this, args);
  };

  DrawingShorthand.prototype.r = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.addRect.apply(this, args);
  };

  DrawingShorthand.prototype.rs = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.addRects.apply(this, args);
  };

  DrawingShorthand.prototype.rt = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.addRotate.apply(this, args);
  };

  DrawingShorthand.prototype.p = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.setPos.apply(this, args);
  };

  DrawingShorthand.prototype.xy = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.setXy.apply(this, args);
  };

  DrawingShorthand.prototype.w = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.setWay.apply(this, args);
  };

  DrawingShorthand.prototype.sc = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.setScale.apply(this, args);
  };

  DrawingShorthand.prototype.oc = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.onCollision.apply(this, args);
  };

  DrawingShorthand.getter('d', function() {
    return this.draw;
  });

  DrawingShorthand.getter('ec', function() {
    return this.enableCollision;
  });

  DrawingShorthand.getter('dc', function() {
    return this.disableCollision;
  });

  DrawingShorthand.getter('mx', function() {
    return this.addMirrorX;
  });

  DrawingShorthand.getter('my', function() {
    return this.addMirrorY;
  });

  DrawingShorthand.getter('cl', function() {
    return this.clear;
  });

  return DrawingShorthand;
...
FiberShorthand = (function(_super) {
  __extends(FiberShorthand, _super);

  function FiberShorthand() {
    return FiberShorthand.__super__.constructor.apply(this, arguments);
  }

  FiberShorthand.prototype.dr = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.doRepeat.apply(this, args);
  };

  FiberShorthand.prototype.d = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.doOnce.apply(this, args);
  };

  FiberShorthand.prototype.w = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.wait.apply(this, args);
  };

  FiberShorthand.getter('n', function() {
    return this.next;
  });

  FiberShorthand.getter('r', function() {
    return this.remove;
  });

  FiberShorthand.getter('isRemoving', function() {
    return this.removing;
  });

  FiberShorthand.getter('ir', function() {
    return this.removing;
  });

  return FiberShorthand;
...
TextActor = (function(_super) {
  ...
  TextActor.prototype.update = function() {
    if (this.ticks === 0) {
      this.vel.d(this.duration);
    }
    Display.drawText(this.text, this.pos.x, this.pos.y, this.xAlign, 0, this.color, this.scale);
  ...
  ParticleActor.prototype.update = function() {
    ...
    if (this.particle != null) {
      ...
      for (i = _i = 1, _ref = pp.number; 1 <= _ref ? _i <= _ref : _i >= _ref; i = 1 <= _ref ? ++_i : --_i) {
        p = new ParticleActor;
        p.pos.v(pp.pos);
        p.vel.aw(pp.way + ((-ww).rr(ww)), pp.speed * (0.5.rr(1.5)));
        p.color = pp.color;
        p.size = pp.size;
    ...
    Display.fillRect(this.pos.x, this.pos.y, this.size, this.size, this.color);
    if (this.ticks >= this.duration - 1) {
      return this.remove();
    }
  };
...
Sound = (function() {
  ...
  Sound.update = function() {
    ...
    if (Game.isPaused || !Game.running || !this.isEnabled) {
      return;
    }
...
Vector = (function() {
  ...
  Vector.prototype.setNumber = function(v) {
    if (v == null) {
      v = 0;
    }
    this.xy(v, v);
  ...
  Vector.prototype.setValue = function(v) {
    this.x = v.x;
    this.y = v.y;
    return this;
  };
  ...
  Vector.prototype.addWay = function(way, speed) {
    var rw;
    rw = way * PI / 180;
    this.x += (sin(rw)) * speed;
    this.y -= (cos(rw)) * speed;
  ...
  Vector.prototype.rotate = function(way) {
    var px, w;
    if (way === 0) {
      return this;
    }
  ...
  Vector.prototype.distanceTo = function(pos) {
    var ox, oy;
    ox = pos.x - this.x;
    oy = pos.y - this.y;
  ...
  Vector.prototype.wayTo = function(pos) {
    return (atan2(pos.x - this.x, -(pos.y - this.y))) * 180 / PI;
  };

  Vector.prototype.isIn = function(spacing, minX, maxX, minY, maxY) {
    var _ref, _ref1;
    if (spacing == null) {
      spacing = 0;
    }
...
VectorShorthand = (function(_super) {
  __extends(VectorShorthand, _super);

  function VectorShorthand() {
    return VectorShorthand.__super__.constructor.apply(this, arguments);
  }

  VectorShorthand.getter('l', function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.getLength();
  });

  VectorShorthand.getter('w', function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.getWay.apply(this, args);
  });

  VectorShorthand.prototype.wt = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.wayTo.apply(this, args);
  };

  VectorShorthand.prototype.aw = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.addWay.apply(this, args);
  };

  VectorShorthand.prototype.rt = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.rotate.apply(this, args);
  };

  VectorShorthand.prototype.xy = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.setXy.apply(this, args);
  };

  VectorShorthand.prototype.n = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.setNumber.apply(this, args);
  };

  VectorShorthand.prototype.v = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.setValue.apply(this, args);
  };

  VectorShorthand.prototype.ii = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.isIn.apply(this, args);
  };

  VectorShorthand.prototype.dt = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.distanceTo.apply(this, args);
  };

  VectorShorthand.prototype.a = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.add.apply(this, args);
  };

  VectorShorthand.prototype.d = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.div.apply(this, args);
  };

  VectorShorthand.prototype.m = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.mul.apply(this, args);
  };

  VectorShorthand.prototype.s = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.sub.apply(this, args);
  };

  return VectorShorthand;
...
Config = (function() {
  ...
  Config.lineNoise = true;

  Config.getter('allowLineNoise', function() {
    return this.lineNoise;
  });

  Config.setter('allowLineNoise', function(value) {
    this.lineNoise = value;
    if (!this.lineNoise) {
      return DisableLineNoise();
    } else {
      return EnableLineNoise();
    }
  });
